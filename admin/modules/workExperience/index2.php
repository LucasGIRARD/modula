    ...
    foreach ($moduleAction as $key => &$value) {
        switch ($value) {
            ...
            case 'dbVars':
                ...
                switch ($action) {
                    case 'listing':
                        $donneesSQL = select($connection, "SELECT rwe.id, rwe.enabled, rwet.name AS type, 
                        ...
                        foreach ($donneesSQL as $value) {
                            $workExperiences[$value['id']]['enabled'] = $value['enabled'];
            ...
            case 'listView':
                ...
                $contentView = 'modules/workExperience/view.php';

                break;
            case 'addView':
                $actionDisplay = "Ajouter";
                $contentView = 'modules/workExperience/view_add.php';
                break;
            case 'nextView':
                $actionDisplay = "Ajouter";
                $contentView = 'modules/workExperience/view_add_' . $nextStep . '.php';
                break;
            case 'modifyView':
                $actionDisplay = "Modifier";
                $contentView = 'modules/workExperience/view_modify.php';
                break;
            case 'parametersView':
                break;
            case 'writeFile':
