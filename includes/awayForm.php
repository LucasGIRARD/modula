<div id="away">
    <form method="post" action="?page=work">
        <div>
            ...
            <label for="return">Date de retour :</label><input type='text' name='returnDay' id='return' size='1' maxlength='2' value='<?php echo date("d")+1; ?>' /> / <input type='text' name='returnMonth' size='1' maxlength='2' value='<?php echo date("m"); ?>' /> / <input type='text' name='returnYear' size='2' maxlength='4' value='<?php echo date("Y"); ?>' /> à <input type='text' name='returnHour' size='1' maxlength='2' value='12' /> H <input type='text' name='returnMinute' size='1' maxlength='2' value='00' /><br />
